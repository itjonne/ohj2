 ...
 * @version 2020.11.14 18:30:10 // Generated by ComTest
 *
 */
...
public class JasenTest {
  ...
  public void testRekisteroi90() {    // Jasen: 90
    ...
    testi2.rekisteroi(); 
    assertEquals("From: Jasen line: 95", 3, testi.getJasenId()); 
    assertEquals("From: Jasen line: 96", 4, testi2.getJasenId()); 
  } // Generated by ComTest END
  ...
  /** testToString170 */
  @Test
  public void testToString170() {    // Jasen: 170
    Jasen jasen = new Jasen(); 
    jasen.setJasenId(1); 
    jasen.setEtunimi("Aku"); 
    jasen.setSukunimi("Ankka"); 
    assertEquals("From: Jasen line: 175", "1|Aku|Ankka", jasen.toString()); 
    Jasen jasen2 = new Jasen(); 
    jasen2.setJasenId(2); 
    jasen2.setEtunimi("Roope"); 
    jasen2.setSukunimi("Setä"); 
    assertEquals("From: Jasen line: 180", "2|Roope|Setä", jasen2.toString()); 
  } // Generated by ComTest END
}